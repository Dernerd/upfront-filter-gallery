...
add_shortcode('PFG', 'upfront_filter_gallery_shortcode');
function upfront_filter_gallery_shortcode($post_id) {
	ob_start();
	...
	$pf_gallery_settings = unserialize(base64_decode(get_post_meta( $post_id['id'], 'upfront_filter_gallery'.$post_id['id'], true)));
