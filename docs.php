...
if(isset($_POST['action']) == "add-category"){
	...
	update_option( 'upfront_portfolio_filter_gallery_categories', $all_category);
...
<div class="wrap">
	<div id="welcome-panel" class="welcome-panel">
		<div class="welcome-panel-content">
			<h1> Welcome to UpFront Filter Gallery Plugin Docs </h1>
			...
			<p> Now, go to the plugin menu "UpFront Filter Gallery" and click on "Add New UpFront Filter Gallery" page. </p>
